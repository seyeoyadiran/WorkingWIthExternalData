...
function _breedSelectorHandler() {
  _breedSelectorHandler = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var breedId, carousel, headers, requestOptions, ret, images, breedInfo, breedName, breedDescr, breedLife, breedWiki;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 6;
          return _axios.default.get("https://api.thecatapi.com/v1/images/search?api_key=".concat(API_KEY, "&breed_ids=").concat(breedId, "&limit=10"), requestOptions);
        case 6:
          ret = _context2.sent;
          images = ret.data;
          carousel.innerHTML = '';
...
//# sourceMappingURL=/JavascriptAxiosLab.e31bb0bc.js.map