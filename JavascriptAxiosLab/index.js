...
async function breedSelectorHandler() {
  ...
  const ret = await axios.get(`https://api.thecatapi.com/v1/images/search?api_key=${API_KEY}&breed_ids=${breedId}&limit=10`, requestOptions);
  
  const images = ret.data;
  carousel.innerHTML = '';
  infoDump.innerHTML = '';
